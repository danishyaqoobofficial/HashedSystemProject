        ...
        <>
            <main className="bg-[#E8F0FA] w-full ">
                <section className="max-w-[1200px] mx-auto pt-[30px] md:pt-[60px] xl:pt-[80px] flex gap-[18px] md:gap-[22px] px-[12px] sm:px-[20px] lg:flex-row flex-col ">
                    <div className="flex-1 pt-[32px] ">
                        <h2 className="text-[38px] sm:text-[42px] md:text-[60px] text-[#001436] font-[600] text-start leading-[50px] md:leading-[70px] line-clamp-3 ">Software Development & IT Company</h2>
            ...
            <div className="bg-[#fff] py-[42px] px-[8px] sm:px-[12px] ">
                <div className="max-w-[1200px] mx-auto flex items-center gap-[12px] md:gap-[32px] justify-between sm:flex-row flex-col ">
                    <div className=" flex-1 ">
                        <h2 className="text-[#0A0E19] text-[32px] md:text-[38px] font-[600] text-center sm:text-start ">Our Valued Clients</h2>
            ...
            <div className="bg-[#E8F0FA] py-[44px] w-full px-[12px] ">
                <div className="max-w-[1200px] mx-auto ">
                    <h2 className=" text-center text-[32px] md:text-[40px] text-[#0A0E19] font-[600] ">Our Services</h2>
            ...
            <div className="bg-[#fff] w-full ">
                <div className="max-w-[1200px] mx-auto">
                    <div className=" py-[52px] px-[8px] sm:px-[12px] ">
                        ...
                        <h2 className=" text-center text-[#0A0E19] font-[600] mt-[20px] leading-[50px] text-[32px] md:text-[42px] ">We craft a unique solution for every project</h2>
            ...
            <div className="w-full bg-[#fff]  " >
                <div className="max-w-[1200px] mx-auto py-[32px] px-[12px] md:px-[20px] ">
                    ...
                    <h2 className="text-center text-[#0A0E19] font-[600] mt-[32px] leading-[50px] text-[42px] ">Awards & Recognitions</h2>
                    <div className="flex items-center justify-center gap-[18px] mt-[30px] flex-wrap ">
                        <img className="h-[126px] " src={awardImg1} alt="" />
                        <img className="h-[126px] " src={awardImg2} alt="" />
                        <img className="h-[126px] " src={awardImg3} alt="" />
                        <img className="h-[126px] " src={awardImg4} alt="" />
                        <img className="h-[126px] " src={awardImg5} alt="" />
                        <img className="h-[126px] " src={awardImg6} alt="" />
                    </div>
                    <div className="flex items-center justify-center gap-[8px] mt-[32px] ">
                        <span className="flex items-center justify-center h-[42px] w-[46px] cursor-pointer bg-[#fff] rounded-[12px] border border-[#0D99FF] ">
                            <svg width="18" height="15" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full bg-[#E8F0FA] ">
                <div className="max-w-[900px] mx-auto py-[52px] px-[8px] sm:px-[12px] ">
                    <div className="flex items-center justify-center ">
                    ...
                    <div className="flex items-center lg:items-start mt-[22px] gap-[22px] justify-center flex-wrap lg:flex-row flex-col ">
                        <BlogCard bg = {bg1} date = '21 May 2024' heading = 'What is agile software development?' peragraph = 'Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum h' />
            ...
            <div className="w-full bg-[#fff] ">
                <div className="max-w-[1200px] mx-auto py-[50px] px-[12px] md:px-[20px] ">
                    <h2 className=" text-center text-[#0A0E19] font-[600] leading-[50px] text-[42px] max-w-[660px] mx-auto ">Have a project? Let's discuss</h2>
